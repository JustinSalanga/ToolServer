...
const GPT_MODELS = [
    // GPT-5 series
    { id: 'gpt-5.6-terra', name: 'GPT-5.6 Terra', description: 'Input $2.50 | Cached $0.25 | Output $15.00' },
    { id: 'gpt-5.6-luna', name: 'GPT-5.6 Luna', description: 'Input $1.00 | Cached $0.10 | Output $6.00' },
